...
const AddTicket = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const imageUrl =
                imageRes.data?.data?.display_url || imageRes.data?.data?.url;
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs opacity-70">
                                Create a new ticket listing for your customers
                            </p>
                        </div>
                    </div>
                    {/* Visual Decor */}
                ...
                >
                    ...
                    <div className="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div
                                className={`relative w-full bg-transparent h-48 rounded-2xl border-2 border-dashed ${errors.image ? "border-red-300" : "border-gray-200 bg-gray-50"
                                    } flex flex-col items-center justify-center overflow-hidden transition-all group hover:border-primary/50`}
                            >
                                {imagePreview ? (
                                    <>
                                        <img
               ...
               transition-all z-20"
                        ...
                        <div className="bg-base-200 rounded-xl p-4 border border-base-300/50">
                            ...
                            <div className="space-y-3">
                                <div className="form-control">
                                    <label className="text-xs opacity-60 mb-1">
                                        Company Name
                                    </label>
                                    <input
                                        type="text"
                                        ...
                                        readOnly
                                        className="input input-sm input-bordered w-full bg-base-100/50 text-base-content/60 cursor-not-allowed"
                                    />
                                </div>
                                <div className="form-control">
                                    <label className="text-xs opacity-60 mb-1">
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative">
                            <div className="form-control">
                                <label className="label font-semibold text-xs uppercase opacity-70">
                                    From
                                </label>
                        ...
                        <div className="form-control">
                            ...
                            <div className="relative">
                                <LuFileText className="absolute left-3 top-3.5 text-base-content/50" />
                                <textarea
                                    placeholder="e.g. Comfortable AC bus with sleeper seats..."
                                    className="textarea textarea-bordered pl-10 w-full h-24"
