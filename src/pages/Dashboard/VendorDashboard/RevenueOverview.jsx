...
const RevenueOverview = () => {
  ...
  const { data: chartData = [], isLoading } = useQuery({
    ...
    enabled: !!user?.email,
    queryFn: async () => {
      // const res = await axiosSecure.get(`/vendor/revenue-stats`,user?.email);
      const res = await axiosSecure.get('/vendor/revenue-stats', {
  ...
  }, { totalRevenue: 0, totalSold: 0, totalAdded: 0 }); // প্রাথমিক ভ্যালু
