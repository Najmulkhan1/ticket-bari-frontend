...
import { LuLogOut, LuUser, LuSun, LuMoon } from "react-icons/lu"; // Added Icons
        ...
        <div className={wrapperClass}>
            ...
            `}>
                ...
                <div className="navbar-end hidden lg:flex items-center gap-2">
                    {/* Theme Toggle Button */}
                    <button onClick={toggleTheme} className="btn btn-ghost btn-circle text-base-content/80 hover:text-primary transition-transform hover:rotate-12">
                ...
                `}>
                    <div className="bg-base-100/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl p-4 flex flex-col gap-2 mx-0">
                        ...
                        <button
                            onClick={toggleTheme}
                            className="p-3 rounded-xl transition-all duration-200 flex items-center justify-between hover:bg-base-200 text-base-content/80 hover:pl-5"
                        >
